...
namespace SweetSugar.Scripts.GUI.Boost
{
    ...
    public class BoostShop : MonoBehaviour
    {
        ...
        {
            // Disable the BoostShop immediately upon enabling
        ...
        {
            // Prevent BoostShop from being shown
            // gameObject.SetActive(true);

            // Keep boost icons disabled
            boost.boostIconObject.SetActive(false);

            // Commenting out text and price updates as BoostShop is disabled
